...
namespace gazebo
{
  ...
  private:
    ...
    math::Vector3d prev_lin_vel_;
    math::Vector3d prev_ang_vel_;
    math::Pose3d pose_;
    math::Vector3d euler_;
    math::Vector3d vel_linear_body_;
    math::Vector3d vel_angular_body_;
    math::Vector3d acceleration;
    math::Vector3d angular_velocity_;
    math::Vector3d angular_acceleration_;
